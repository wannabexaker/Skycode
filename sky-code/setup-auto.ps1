...
$skybridgePath = "C:\Projects\MyTests\Code\skybridge\target\release\skybridge.exe"
...
$skyPath = "C:\Projects\MyTests\Code\sky-code\target\release\sky.exe"
...
# Run doctor check
cd C:\Projects\MyTests\Code\sky-code
