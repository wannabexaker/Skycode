...
fn sky_binary() -> PathBuf {
    ...
    for candidate in [
        ...
        r"C:\Projects\MyTests\Code\sky-code\target\release\sky.exe",
        r"C:\Projects\MyTests\Code\claw-code\rust\target\release\sky.exe",
    ] {
...
fn skybridge_binary() -> PathBuf {
    ...
    for candidate in [
        ...
        r"C:\Projects\MyTests\Code\skybridge\target\release\skybridge.exe",
        r"C:\Projects\MyTests\Code\claw-code\rust\target\release\skybridge.exe",
    ] {
        let p = PathBuf::from(candidate);
        if p.exists() { return p; }
    }
