...
Skycode brings the  Code experience to local LLMs — interactive CLI, tool calling, file operations, git commands, multi-agent workflows — all running 100% on your machine via [Ollama](https://ollama.ai).
